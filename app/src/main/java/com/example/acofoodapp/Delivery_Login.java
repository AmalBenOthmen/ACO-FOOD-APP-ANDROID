...
public class Delivery_Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            email = (TextInputLayout)findViewById(R.id.LemailDelevery);
            pass = (TextInputLayout)findViewById(R.id.LpasswordDelevery);
            Signin = (Button)findViewById(R.id.button4Delevery);
            signup = (TextView) findViewById(R.id.textView3Delevery);
            Forgotpassword = (TextView)findViewById(R.id.forgotpassDelevery);
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if(task.isSuccessful()){
                                    ...
                                    if(Fauth.getCurrentUser().isEmailVerified()){
                                        ...
                                        Intent Z = new Intent(Delivery_Login.this,DeleveryFoodPanel_BottomNavigation.class);
                                        startActivity(Z);
                                        finish();
            ...
            Forgotpassword.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(Delivery_Login.this,DeleveryForgotPassword.class));
                    finish();
                }
            });
