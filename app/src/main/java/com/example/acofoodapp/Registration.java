...
public class Registration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirstName = (TextInputLayout) findViewById(R.id.FirstNameCustomer);
        Lastname = (TextInputLayout) findViewById(R.id.LastnameCustomer);
        Email = (TextInputLayout) findViewById(R.id.EmailCustomer);
        Password = (TextInputLayout) findViewById(R.id.PasswordCustomer);
        confirmpass = (TextInputLayout) findViewById(R.id.ConfirmpasswdCustomer);
        mobile = (TextInputLayout) findViewById(R.id.PhoneCustomer);
        signup = (Button) findViewById(R.id.btnSignupCustomer);
        Emaill = (Button) findViewById(R.id.btnemailCustomer);
        Phone = (Button) findViewById(R.id.btnphoneCustomer);
