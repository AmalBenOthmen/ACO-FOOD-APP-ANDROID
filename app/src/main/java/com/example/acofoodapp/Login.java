...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            email = (TextInputLayout)findViewById(R.id.Lemailc);
            pass = (TextInputLayout)findViewById(R.id.Lpasswordc);
            Signin = (Button)findViewById(R.id.button4c);
            signup = (TextView) findViewById(R.id.textView3c);
            Forgotpassword = (TextView)findViewById(R.id.forgotpassc);
